...
<html>
    ...
    <body>
        ...
        <div class="col-sm-5">
            ...
            <form action="<?php echo base_url(); ?>product/insert" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="intCategory">Product Category</label>
                    <?php echo $getProductCatData; ?>
                </div>
                <div class="form-group">
                    <label for="varName">Product Name</label>
